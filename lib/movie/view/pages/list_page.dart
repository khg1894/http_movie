...
import 'package:flutter_http_1/movie/model/repository/post_repository.dart';
...
class ListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Text("유저번호 : ${postDTOTable.rank}"),
          Divider(),
          Text("글 번호 : ${postDTOTable.auiCnt}"),
          Divider(),
          Text("글 제목 : ${postDTOTable.movieNm}"),
          Divider(),
